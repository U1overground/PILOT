...
class CrossEntropy(nn.Module):
    ...
    def forward(self, score, target):
        # --- FIX: Robustly handle single tensor input ---
        # This replaces the brittle 'if config.MODEL.NUM_OUTPUTS == 1' check
...
def weighted_bce(bd_pre, target):
    ...
    # --- STABILITY FIX: Add epsilon to avoid division by zero ---
    sum_num = sum_num + 1e-6 
